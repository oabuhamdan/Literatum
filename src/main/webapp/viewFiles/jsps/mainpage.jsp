...
<div class="row edrive-wrapper">
                        ...
                        <ul class="sub-list-box">
                            <li>
                                <div style="padding-left: 3em;">
                                    <i class="fas fa-caret-down" style="visibility: hidden;"></i>
                                    <a href="">Chemistry</a>
                                </div>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="sub-list-box">
                            <li>
                                <div style="padding-left: 3em;">
                                    <i class="fas fa-caret-down" style="visibility: hidden;"></i>
                                    <a href="">Unit Test I</a>
                                </div>
                            </li>
                            <li>
                                <div style="padding-left: 3em;">
                                    <i class="fas fa-caret-down"></i>
                                    <a href="">Unit Test II</a>
                                </div>
                            </li>
                        </ul>
                    </li>
    ...
    <div class="col-lg-10 col-md-9 col-sm-8 col-12 edrive-space">
        ...
        <div class="row edrive-table-data-row">
            <div class="col-lg-3 col-md-3 col-sm-3 col-12 data-name"><i class="fas fa-folder edrive-file-icon"></i> <a href="" title="Formulae">Formulae</a></div>
            <div class="col-lg-2 col-md-3 col-sm-3 col-12 data-info">23/11/2018 15:30</div>
        ...
        <div class="row edrive-table-data-row">
            <div class="col-lg-3 col-md-3 col-sm-3 col-12 data-name"><i class="fas fa-folder edrive-file-icon"></i> <a href="" title="Diagrams">Diagrams</a></div>
            <div class="col-lg-2 col-md-3 col-sm-3 col-12 data-info">23/11/2018 15:30</div>
            <div class="col-lg-2 col-md-2 col-sm-2 col-12 data-info">Folder</div>
            <div class="col-lg-1 col-md-1 col-sm-1 col-12 data-info">-</div>
            <div class="col-lg-4 col-md-3 col-sm-3 col-12 data-info"></div>
        ...
        <div class="row edrive-table-data-row">
            <div class="col-lg-3 col-md-3 col-sm-3 col-12 data-name"><i class="fas fa-folder edrive-file-icon"></i> <a href="" title="Previous Year Question Papers">Previous Year Question Papers</a></div>
            <div class="col-lg-2 col-md-3 col-sm-3 col-12 data-info">23/11/2018 15:30</div>
            <div class="col-lg-2 col-md-2 col-sm-2 col-12 data-info">Folder</div>
            <div class="col-lg-1 col-md-1 col-sm-1 col-12 data-info">-</div>
            <div class="col-lg-4 col-md-3 col-sm-3 col-12 data-info"></div>
